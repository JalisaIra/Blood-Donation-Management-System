 ...
 * @author User
 */
public class PlasmaDonor extends javax.swing.JFrame {

    /**
     * Creates new form PlasmaDonor
     */
    public PlasmaDonor() {
        initComponents();
    }
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select Donor_Bio_Details.Donor_Id,Name,FatherName,MotherName,DOB,MobileNo,Gender, email,BloodGroup,address_ ,PreviousDisease,sample.Plasma,days,Donation_Category,\n" +
...
" where Plasma between 60 and 100");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlasmaDonor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
